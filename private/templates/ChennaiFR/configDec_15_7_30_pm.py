...
def config(settings):
    ...
    settings.base.theme = "ChennaiFR"
    settings.base.system_name = T("Chennai Flood Relief Management Platform")
    settings.base.system_name_short = T("Chennai Flood Relief")	
    # Enable Guided Tours
